...
export function Pill({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 whitespace-nowrap rounded-full px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-[0.04em] ${PILL_TONE[tone]}`}
    >
      {children}
    </span>
  );
